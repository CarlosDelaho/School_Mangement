...
nuevo_usuario = EvidenceActivitiesController()


@router.post("/create_evidence_activities")
async def create_evidence_activities(evidence_activities:EvidenceActivities):
...
async def edit_comments_activities(id:int, evidence_activities:EvidenceActivities):
