...
class ParticipantsActivitiesController:
        
    def create_participant_activity(self, participant: ParticipantsActivities):   
        try:
    ...
    def edit_participant_activity(self, id:int, participant: ParticipantsActivities):
        try:
            conn = get_db_connection()
            cursor = conn.cursor()
