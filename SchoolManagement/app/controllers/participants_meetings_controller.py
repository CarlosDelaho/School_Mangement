...
class ParticipantsMeetingsController:
        
    def create_participant_meeting(self, participant: ParticipantsMeetings):   
        try:
    ...
    def edit_participant_meeting(self, id:int, participant: ParticipantsMeetings):
        try:
            conn = get_db_connection()
            cursor = conn.cursor()
