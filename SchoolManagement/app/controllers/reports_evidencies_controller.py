...
class ReportsEvidenciesController:
        
    def create_reports_evidencies(self, reports_evidencies: ReportsEvidencies):   
        try:
    ...
    def edit_report_evidencies(self, reports_evidencies_id:int, reports: ReportsEvidencies):
        try:
            conn = get_db_connection()
            cursor = conn.cursor()
