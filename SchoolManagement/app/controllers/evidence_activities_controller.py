...
from models.evidence_activities_model import EvidenceActivities
from fastapi.encoders import jsonable_encoder

class EvidenceActivitiesController:
        
    def create_evidence_activities(self, evidence_activities: EvidenceActivities):   
        try:
    ...
    def edit_comments_evidence_activities(self, evidence_activities_id:int, evidence_activities:EvidenceActivities):
        try:
            conn = get_db_connection()
            cursor = conn.cursor()
